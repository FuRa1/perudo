 ...
 * reference the CSS custom properties defined once in styles.css. A future texture-backed or 3D
...
/** The owner's open cup is sized responsively by CSS (`.dice-cup-owner-shell` in styles.css, a
...
/** Named CSS classes (defined in styles.css) for each visual layer — centralizes every color and
